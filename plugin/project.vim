...
function! s:Project(filename) " <<<
    ...
    if !exists('g:proj_window_width')
        let g:proj_window_width=34              " Default project window width
    endif
...
"imap ò <Esc>gf<C-W>K<c-o>zR<c-o>i<Esc> let s:project_bol==0
"nmap ò gf<C-W>K<Esc>zRi<Esc>let s:project_bol==0
...
imap ò <Esc>gf<C-W>K<c-o>zR<c-o><Esc>:let g:project_bol=0<Esc>i
nmap ò gf<C-W>K<Esc>zR<Esc>:let g:project_bol=0<Esc>i
