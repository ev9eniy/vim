...
"Alt+Shift+- !=
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html imap ﬂ !=
...
"C-Insert
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html imap Œ’ <c-o>ve<C-c>
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html imap Œ’Œ’ <c-o>vf]<C-c>
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html imap Œ’Œ’Œ’ <c-o>v2f]<C-c>
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html imap Œ’Œ’Œ’Œ’ <c-o>v3f]<C-c>
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html imap Œ’Œ’Œ’Œ’Œ’ <c-o>v4f]<C-c>
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html nmap Œ’ ve<C-c>i
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html nmap Œ’Œ’ vf]<C-c>i
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html nmap Œ’Œ’Œ’ v2f]<C-c>i
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html nmap Œ’Œ’Œ’Œ’ v3f]<C-c>i
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html nmap Œ’Œ’Œ’Œ’Œ’ v4f]<C-c>i
...
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html imap ˆ _value
autocmd BufNewFile,BufRead,BufWinEnter *.php,*.cphp,*.html imap Ù _title
